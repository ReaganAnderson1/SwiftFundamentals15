...
var myname = User(name: "Reagan", age: 25, height: 5.8, weight: 250, activityLevel: 6)
print ("My name is \(myname.name), I'm \(myname.age) years old, I am \(myname.height) tall and \(myname.weight) with an activity level of \(myname.activityLevel)")
/*:
...
let newDistance = Distance(feet: 14)
print (newDistance.meters)
/*:
