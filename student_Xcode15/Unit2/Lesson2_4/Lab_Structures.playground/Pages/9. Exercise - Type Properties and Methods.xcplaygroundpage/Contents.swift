...
struct User {
    ...
    static var currentUser = User(userName: "GeniesBottle", email: "youlostthegame@gmail.com" , age: 25)
    
    static func logIn(user:User){
        currentUser = user
        print("\(user.userName) logged on ")
    }
}
 ...
 */
User.logIn(user: User(userName: "GeniesBottle", email: "youlostthegame@gmail.com" , age: 25))
