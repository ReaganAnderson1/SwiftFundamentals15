...
let favorite = Book(title: "Murder on the Orient Express", author: "Agatha Christie", pages: 272, price: 15)
/*:
...
let PC = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 0)
Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2017)
/*:
...
var myHeight = Height(heightInInches: 57)
